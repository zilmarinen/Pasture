...
class WalnutTree: Codable, Hashable, ObservableObject {
    
    static let `default`: WalnutTree = WalnutTree()
    ...
    static func == (lhs: WalnutTree, rhs: WalnutTree) -> Bool {
